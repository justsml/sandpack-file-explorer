import { useSandpack, DirectoryIconOpen, DirectoryIconClosed, FileIcon, CloseIcon } from '@codesandbox/sandpack-react';
import React2, { createContext, forwardRef, useContext, useState, useRef, memo as memo$1, useEffect, useImperativeHandle, useMemo, useCallback, useLayoutEffect, isValidElement, cloneElement, useInsertionEffect, Fragment as Fragment$1, createElement, useId, Component } from 'react';
...
var CustomSandpackContext = createContext(null);
...
var SandpackFilesProvider = ({ children, onMoveFile }) => {
  ...
  return /* @__PURE__ */ jsx(CustomSandpackContext.Provider, { value, children });
};
...
function j({ debounce: n, scroll: t2, polyfill: o, offsetSize: i } = { debounce: 0, scroll: false, offsetSize: false }) {
  ...
  const [c2, h2] = useState({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }), e = useRef({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: c2, orientationHandler: null }), d2 = n ? typeof n == "number" ? n : n.scroll : null, f2 = n ? typeof n == "number" ? n : n.resize : null, w3 = useRef(false);
  useEffect(() => (w3.current = true, () => void (w3.current = false)));
  const [z, m2, s2] = useMemo(() => {
    const r = () => {
  ...
  return X(s2, !!t2), W(m2), useEffect(() => {
    v2(), b();
  }, [t2, s2, m2]), useEffect(() => v2, []), [L2, c2, z];
}
function W(n) {
  useEffect(() => {
    const t2 = n;
...
var PlaceholderProvider = function(props) {
  var _a = useState(initialState3.dropTargetId), dropTargetId = _a[0], setDropTargetId = _a[1];
  var _b = useState(initialState3.index), index = _b[0], setIndex = _b[1];
...
var SingleInputForm = ({
  ...
  return /* @__PURE__ */ jsxs("form", { ref: formRef, onSubmit: handleSubmit, children: [
...
var CreateNewNode = ({ dir }) => {
  ...
  return /* @__PURE__ */ jsx(
    "span",
    {
      ...
      children: dir ? /* @__PURE__ */ jsx(DirectoryIconOpen, {}) : /* @__PURE__ */ jsx(FileIcon, {})
    }
  );
};
var FileTreeExplorer = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(DndProvider, { backend: S, options: getBackendOptions(), children: /* @__PURE__ */ jsxs(
    "div",
    {
      style: {
        minHeight: "100%",
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { style: { display: "flex" }, children: [
                /* @__PURE__ */ jsx(CreateNewNode, {}),
                /* @__PURE__ */ jsx(CreateNewNode, { dir: true })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
          Tree,
          {
            ...
            render: (node, { depth, isOpen }) => {
              var _a, _b, _c, _d;
              return !node.text ? /* @__PURE__ */ jsx(Fragment, {}) : /* @__PURE__ */ jsxs(
                "div",
                {
                  style: {
                    marginLeft: depth * 10,
                  ...
                  children: [
                    node.text.includes("addFile") || node.text.includes("addDir") ? /* @__PURE__ */ jsx(
                      SingleInputForm,
                      {
                    ...
                    node.text && !node.text.includes("addFile") && !node.text.includes("addDir") ? /* @__PURE__ */ jsxs(Fragment, { children: [
                      node.droppable ? /* @__PURE__ */ jsxs(
                        "span",
                        {
                          style: {
                          ...
                          children: [
                            isOpen ? /* @__PURE__ */ jsx(DirectoryIconOpen, {}) : /* @__PURE__ */ jsx(DirectoryIconClosed, {}),
                            node.text,
                            isOpen ? "[-] " : "[+] "
                          ]
                        }
...
var SandpackFileTree = () => /* @__PURE__ */ jsx(
  "div",
  {
    style: {
      minWidth: 150,
...
var SandpackFileExplorer = (props) => /* @__PURE__ */ jsx(SandpackFilesProvider, { ...props, children: /* @__PURE__ */ jsx(SandpackFileTree, {}) });
